...
author: "Enoch Kang, Chiehfeng Chen Wen-Hsuan Hou, & Jin-Hua Chen"
date: "Feb. 10, 2023"
description: > 
...
[![Monthly Downloads](http://cranlogs.r-pkg.org/badges/rankinma)](http://cranlogs.r-pkg.org/badges/rankinma)
...
**Step 3.** Visualization using function `PlotBeads()`, `PlotBar()`, or `PlotLine()`.
...
**Step 4.** Visualization using function `PlotBeads()`, `PlotBar()`, or `PlotLine()`.
...
**Step 5.** Visualization using function `PlotBeads()`, `PlotBar()`, or `PlotLine()`.
